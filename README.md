...
Backend данного проекта заключается в обработке массива данных data.csv, после чего создается локально база данных SQLLite3. С помощью DRF создан API с подргрузкой из базы данных для обработки frontend частью информации. Также был реализован поиск по определенным атрибутам. Frontend часть уже обрабатывает полученные данные и выводит все для пользователей.
## БЫСТРЫЙ СТАРТ
